...
(function (t) {
    ...
    function i(e) {
        function n(n, s) {
            t.isPlainObject(s) && t.isPlainObject(e[n]) && !r(n) ? e[n] = i(
                {}, e[n], s) : void 0 !== s && (e[n] = s)
        }
    ...
    function se(n) {
        ...
        return l && (l += "-"), i = n.data(l + "event") || null, i && (i = "object" == typeof i ? t.extend(
            {}, i) :
            {}, r = i.start, null == r && (r = i.time), s = i.duration, o = i.stick, delete i.start, delete i.time, delete i.duration, delete i.stick), null == r && (r = n.data(l + "start")), null == r && (r = n.data(l + "time")), null == s && (s = n.data(l + "duration")), null == o && (o = n.data(l + "stick")), r = null != r ? e.duration(r) : null, s = null != s ? e.duration(s) : null, o = Boolean(o),
            {
                eventProps: i,
                startTime: r,
                duration: s,
    ...
    function me(n, r) {
        ...
        function f(n) {
            ...
            return g.unshift(
                {}), r = t.extend.apply(t, g), s ? (l = r.duration || s.duration, l && (l = e.duration(l), a = b(l), p = 1 === l.as(a)), p && h[a] && (r = t.extend(
                    {}, h[a], r)), u = c[n] || (p ? c[a] : null) || d[n] || (p ? d[a] : null) || r.buttonText || s.buttonText || (l ? o(l) : null) || n, he[n] = {
                        "class": s,
                        options: r,
                        buttonText: u
                    }) : void 0
        ...
        var K, Q = i(
            {}, Ee, r);
        K = Q.lang in Te ? Te[Q.lang] : Te[Ee.lang], K && (Q = i(
            {}, Ee, K, r)), Q.isRTL && (Q = i(
                {}, Ee, be, K ||
                {}, r)), q.options = Q, q.render = l, q.destroy = u, q.refetchEvents = E, q.reportEvents = H, q.reportEventChange = R, q.rerenderEvents = S, q.changeView = c, q.select = F, q.unselect = z, q.prev = _, q.next = P, q.prevYear = V, q.nextYear = A, q.today = N, q.gotoDate = Y, q.incrementDate = O, q.zoomTo = B, q.getDate = Z, q.getCalendar = j, q.getView = X, q.option = $, q.trigger = U, q.isValidViewType = g, q.getViewButtonText = p;
        var J = x(s(Q.lang));
    ...
    function ye(n) {
        ...
        function o(e, i) {
            ...
            if (a) t.isFunction(a) ? (y(), a.call(O, B.clone(), Z.clone(), n.timezone, function (t) {
                ...
                if (u) {
                    ...
                    p && (g[p] = B.format()), m && (g[m] = Z.format()), n.timezone && "local" != n.timezone && (g[v] = n.timezone), y(), t.ajax(t.extend(
                        {}, Ke, e,
                        {
                            data: g,
                            success: function (e) {
        ...
        function H(e, n, i) {
            ...
            if (n = n || B, i = i || Z, e)
                if (e._recurring) {
                    ...
                    for (l = n.clone().stripTime(); l.isBefore(i);)(!r || r[l.day()]) && (a = e.start, u = e.end, d = l.clone(), c = null, a && (d = d.time(a)), u && (c = l.clone().time(u)), h = t.extend(
                        {}, e), D(d, c, !a && !u, h), f.push(h)), l.add(1, "days")
                }
                else f.push(e);
            return f
        }
        ...
        function R(e, n) {
            var i, r, s, o, l = {};
            return n = n ||
                {}, n.start || (n.start = e.start.clone()), void 0 === n.end && (n.end = e.end ? e.end.clone() : null), null == n.allDay && (n.allDay = e.allDay), C(n), i = null !== e._end && null === n.end, r = n.allDay ? S(n.start, e._start) : E(n.start, e._start), !i && n.end && (s = E(n.end, n.start).subtract(E(e._end || O.getDefaultEventEnd(e._allDay, e._start), e._start))), t.each(n, function (t, e) {
                    g(t) && void 0 !== e && (l[t] = e)
        ...
        function _() {
            var e, i = n.businessHours,
                ...
                s = O.getView();
            return i && (e = "object" == typeof i ? t.extend(
                {}, r, i) : r), e ? H(b(e), s.start, s.end) : []
        }
        ...
        function V(e, n) {
            var i, r;
            return n && (i = t.extend(
                {}, n, e), r = H(b(i))[0]), r ? L(e, r) : (e = x(e), P(e))
        }
        ...
        function G(t, e, n, i) {
            ...
            for (o = 0; Q.length > o; o++)
                if (l = Q[o], (!i || i._id !== l._id) && Y(l, t)) {
                    ...
                    if (i) {
                        if (a = F(l.overlap, (l.source ||
                            {}).overlap), a === !1) return !1;
    ...
    De.Class = K, K.extend = function (t) {
        var e, n = this;
        return t = t ||
            {}, R(t, "constructor") && (e = t.constructor), "function" != typeof e && (e = t.constructor = function () {
        ...
        We = K.extend(
            {
                ...
                constructor: function (e, n) {
                    this.options = n = n ||
                        {}, this.sourceEl = e, this.parentEl = n.parentEl ? t(n.parentEl) : e.parent()
                },
                start: function (e) {
        ...
        Xe = De.Grid = je.extend(
            {
                ...
                renderRangeHelper: function (t, e) {
                    var n;
                    n = e ? x(e.event) :
                        {}, n.start = t.start.clone(), n.end = t.end ? t.end.clone() : null, n.allDay = null, this.view.calendar.normalizeEventDateProps(n), n.className = (n.className || []).concat("fc-helper"), e || (n.editable = !1), this.renderHelper(n, e)
                },
                    ...
                    d = new Ie(r.coordMap,
                        {
                            ...
                            dragStop: function (t) {
                                l.stop(!n, function () {
                                    i.isDraggingSeg = !1, r.destroyDrag(), r.showEvent(o), r.trigger("eventDragStop", s[0], o, t,
                ...
                r = new Ie(this.coordMap,
                    {
                        ...
                        dragStop: function (t) {
                            s.isResizingSeg = !1, n(), o.trigger("eventResizeStop", d[0], c, t,
    ...
    var qe = De.View = K.extend(
        {
            ...
            reportExternalDrop: function (e, n, i, r, s) {
                ...
                a && (o = t.extend(
                    {}, a, n), l = this.calendar.renderEvent(o, e.stick)[0]), this.triggerExternalDrop(l, n, i, r, s)
            },
