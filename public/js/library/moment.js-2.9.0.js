...
(function (a) {
    ...
    function T(a, b, c) {
        ...
        switch (a) {
            ...
            case "ddd":
            case "dddd":
                d = c._locale.weekdaysParse(b), null != d ? (c._w = c._w ||
    ...
    function _(a) {
        ...
        for (f = 0; f < a._f.length; f++) g = 0, b = p(
            {}, a), null != a._useUTC && (b._useUTC = a._useUTC), b._pf = d(), b._f = a._f[f], Y(b), I(b) && (g += b._pf.charsLeftOver, g += 10 * b._pf.unusedTokens.length, b._pf.score = g, (null == e || e > g) && (e = g, c = b));
        o(a, c || b)
    }
    ...
    function ib(a, b, c) {
        ...
        return k[2] = b, k[3] = +a > 0, k[4] = c, hb.apply(
            {}, k)
    }
