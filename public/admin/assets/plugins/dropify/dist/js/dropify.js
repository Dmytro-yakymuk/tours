...
; (function (root, factory) {
    ...
    function Dropify(element, options) {
        ...
        var defaults = {
            ...
            tpl: {
                ...
                errorsContainer: '<div class="dropify-preview"><span class="dropify-render"><ul></ul></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
    ...
    Dropify.prototype.readFile = function (input) {
        if (input.files && input.files[0]) {
            ...
            this.file.count = input.files.length;
            var srcBase64 = null;
            var _this = this;
            ...
            for (var i = 0; i < this.file.count; i++) {
                this.setFileInformations(file[i]);
     ...
     * Видаляєм інформацію про фото з поля
     */
     ...
     * Провірям чи сходиться з дозволеними типами загрузки
     * @return {Boolean}
     */
