                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-addrow" class="table table-hover contact-list" data-page-size="10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">
                                                        ...
                                                        <a data-toggle="tooltip" data-original-title="Delete">
                                                            <form method="POST">
                                                                @csrf
                                                                <button class='btn btn-french-5 m-t-5'value="{{ $role->id }}" id="role_delete" type="button">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title" id="myModalLabel">Update Roles</h4> </div>
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form class="form-horizontal form-material" method="POST">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12 m-b-20">
                                                                                <input type="text" class="form-control" value="{{ $role->title }}" name="title_up{{ $role->id }}" placeholder="Slug"> 
                                                                            </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" onclick="update_role({{ $role->id }})" id="role_update" class="btn btn-info waves-effect" data-dismiss="modal">Save</button>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="2">
                                                    <button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#add-role">Add New Role</button>
                                                </td>
                                                <div id="add-role" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" id="role_submit" class="btn btn-info waves-effect" data-dismiss="modal">Save</button>
                                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                                            </div>
                                                        </div>
                                                    </div>
...
@section('js-extra')
    ...
    <script>
        ...
        $('#specie_view').on('click', '#role_delete', function (){

            var role_id = $(this).val();
            $.ajax({
                url: "/api/role_delete/" + role_id,
                method: 'POST',
                type: 'POST'
            }).done(function (result) {
                try{
