                                            ...
                                            @forelse($users as $key => $user)
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">
                                                        ...
                                                        <a data-toggle="modal" data-target="#edit-user{{ ($key+1) }}" data-original-title="Edit"> 
                                                        ...
                                                        <a data-toggle="tooltip" data-original-title="Delete">
                                                            <form method="POST">
                                                                @csrf
                                                                <button class='btn btn-french-5 m-t-5'value="{{ $user->id }}" id="user_delete" type="button">
                                                    ...
                                                    <div id="edit-user{{ ($key+1) }}" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                    <h4 class="modal-title" id="myModalLabel">Update User</h4> </div>
                                                                    ...
                                                                    <form class="form-horizontal form-material" method="POST">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-md-12 m-b-20">
                                                                                <input type="text" class="form-control" value="{{ $user->name }}" name="name_up{{ $user->id }}" placeholder="Name"> 
                                                                            </div>
                                                                            <div class="col-md-12 m-b-20">
                                                                                <input type="text" class="form-control" value="{{ $user->email }}" name="email_up{{ $user->id }}" placeholder="Email"> 
                                                                            </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" onclick="update_user({{ $user->id }})" id="user_update" class="btn btn-info waves-effect" data-dismiss="modal">Save</button>
...
@section('js-extra')
    ...
    <script>
        ...
        function update_user(id) {
            ...
            $.ajax({
                ...
                data: { 
                    ...
                    email: $("input[name='email_up" + id + "']").val()
                }
            }).fail(function (data) {
        ...
        $('#specie_view').on('click', '#user_delete', function (){
