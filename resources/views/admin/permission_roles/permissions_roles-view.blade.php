                                                    ...
                                                    <td>{{ $permission->title }}</td>
                                                        ...
                                                        <td>
                                                            <label class="custom-control custom-checkbox">
                                                                @if($permission->hasPermission($role->name))
                                                                    <input name="{{ $permission->id }}" value="{{ $role->id }}" checked type="checkbox" class="custom-control-input public">
                                                                @else
                                                                    <input name="{{ $permission->id }}" value="{{ $role->id }}" type="checkbox" class="custom-control-input public">
                                                                @endif
...
@section('js-extra')
    ...
    <script>
        ...
        $(".public").change(function(){
            ...
            $.ajax({
                url: "/api/permissions_roles_public",
                method: 'POST',
                type: 'POST',
                data: { 
